...
EX eItem frog_power(eMonster m) {
  switch (m) {
  case moFrog: return itOrbFrog;
  case moPhaser: return itOrbPhasing;
  case moVaulter: return itOrbDash;
  case moWolf: return itOrbFlash;
  case moYeti: return itOrbWinter;
  case moTroll: return itOrbDigging;
  case moGoblin: return itOrbLife;
  case moWorm: return itOrbDomination;
  case moHedge: return itOrbThorns;
  case moDesertman: return itOrbShield;
  case moIvyRoot: return itOrbNature;
  case moIvyHead: return itOrbNature;
  case moIvyBranch: return itOrbNature;
  case moIvyWait: return itOrbNature;
  case moIvyNext: return itOrbNature;
  case moIvyDead: return itOrbNature;
  case moMonkey: return itOrbLightning;
  case moSlime: return itOrbSpeed;
  case moMimic: return itOrbEmpathy;
  case moGolem: return itOrbLife;
  case moEagle: return itOrbSpeed;
  case moSeep: return itOrbAether;
  case moZombie: return itGreenStone;
  case moGhost: return itOrbUndeath;
  case moShadow: return itOrbSlaying;
  case moTentacle: return itOrbDomination;
  case moCultist: return itOrbDragon;
  case moPyroCultist: return itOrbDragon;
  case moGreater: case moGreaterM: return itOrbSlaying;
  case moLesser: case moLesserM: return itOrbSide2;
  case moShark: return itOrbFish;
  case moRunDog: return itOrbSafety;
  case moFireFairy: return itOrbFire;
  case moCrystalSage: return itOrbDragon;
  case moLancer: return itOrbHorns;
  case moFlailer: return itOrbIllusion;
  case moVineBeast: return itOrbWoods;
  case moVineSpirit: return itOrbAether;
  case moDarkTroll: return itOrbDigging;
  case moEarthElemental: return itOrbDigging;
  case moBug0: case moBug1: case moBug2: return itOrbInvis;
  case moWitch: return itOrbChoice;
  case moEvilGolem: return itOrbLife;
  case moCultistLeader: return itOrbDragon;
  case moSlimeNextTurn: return itOrbFlash;
  case moIllusion: return itOrbIllusion;
  case moPirate: return itOrbTime;
  case moCShark: return itOrbFish;
  case moParrot: return itOrbWoods;
  case moHexSnake: return itOrbDomination;
  case moRedTroll: return itOrbMatter;
  case moBomberbird: return itOrbFriend;
  case moAlbatross: return itOrbAir;
  case moTameBomberbirdMoved: return itOrbFriend;
  case moPalace: return itOrbFrog;
  case moFatGuard: return itOrbShield;
  case moSkeleton: return itOrbSlaying;
  case moVizier: return itOrbDiscord;
  case moViking: return itOrbFish;
  case moFjordTroll: return itOrbDigging;
  case moFamiliar: return itOrbMatter;
  case moGargoyle: return itOrbMatter;
  case moFireElemental: return itOrbFire;
  case moAirElemental: return itOrbAir;
  case moOrangeDog: return itOrbFrog;
  case moMetalBeast: return itOrbStunning;
  case moMetalBeast2: return itOrbStunning;
  case moOutlaw: return itOrbSpeed;
  case moMutant: return itOrbNature;
  case moStormTroll: return itOrbMatter;
  case moForestTroll: return itOrbWoods;
  case moRedFox: return itOrbFreedom;
  case moWindCrow: return itOrbAir;
  case moFriendlyGhost: return itOrbUndeath;
  case moRatling: return itOrb37;
  case moFalsePrincess: return itOrbPhasing;
  case moRoseLady: return itOrbImpact;
  case moRoseBeauty: return itOrbBeauty;
  case moTortoise: return itOrbShell;
  case moDragonHead: case moDragonTail: return itOrbDomination;
  case moGadfly: return itOrbBull;
  case moResearcher: return itOrbTeleport;
  case moSparrowhawk: return itOrbEnergy;
  case moKrakenH: case moKrakenT: return itOrbSword;
  case moDraugr: return itOrbSword2;
  case moBat: return itOrbRecall;
  case moReptile: return itOrbDash;
  case moHerdBull: case moRagingBull: case moSleepBull: return itOrbHorns;
  case moButterfly: return itOrbHorns;
  case moNarciss: return itOrbBull;
  case moMirrorSpirit: return itOrbEmpathy;
  case moHunterDog: case moHunterGuard: case moHunterChanging: return itOrbSide3;
  case moTerraWarrior: return itOrbSide1;
  case moJiangshi: return itOrbSide1;
  case moVoidBeast: return itOrbAether;
  case moLavaWolf: return itOrbLava;
  case moIceGolem: return itOrbWinter;
  case moSalamander: return itOrbFire;
  case moPair: return itOrbChaos;
  case moHexDemon: return itOrbSlaying;
  case moAltDemon: return itOrbSlaying;
  case moMonk: return itGreenStone;
  case moCrusher: return itOrbSlaying;
  case moSwitch1: case moSwitch2: return itOrbPhasing;
  case moBrownBug: return itOrbAether;
  case moAcidBird: return itOrbAir;
  case moVariantWarrior: case moVariantWarrior2: return itOrbIntensity;
  case moFallingDog: return itOrbGravity;
  case moPike: return itOrbFish;
  case moRusalka: return itOrbPlague;
  case moHexer: return itOrbPurity;
  case moAnimatedDie: return itOrbLuck;
  case moAngryDie: return itOrbLuck;
  default: return itNone;
    }
  }
