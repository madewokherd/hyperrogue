...
ifeq (${OS},linux)
  CXXFLAGS_EARLY += -DLINUX -I /usr/include/SDL -I${CURDIR}/submodules/apclientpp -I${CURDIR}/submodules/json/include -I${CURDIR}/submodules/valijson/include -I${CURDIR}/submodules/websocketpp -I${CURDIR}/submodules/wswrap/include
  EXE_EXTENSION :=
